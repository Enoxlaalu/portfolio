...
const SKILL_GROUPS = [
  ...
  {
    title: 'State & Data',
    skills: ['Redux', 'MobX', 'Zustand', 'TanStack Query', 'GraphQL'],
  },
  {
    title: 'Tooling',
    skills: ['Vite', 'Webpack', 'Babel', 'Babel Plugins', 'Grunt', 'Gulp'],
  },
  {
    title: 'Testing',
    skills: ['Jest', 'Cypress', 'Enzyme', 'Puppeteer', 'Selenium'],
  },
  {
    title: 'UI / Styling',
    skills: ['CSS Modules', 'SASS', 'LESS', 'Tailwind'],
  },
  {
    title: 'Other',
    skills: ['Vue.js', 'jQuery', 'Backbone.js', 'Node.js', 'Git', 'GitLab'],
  },
];
