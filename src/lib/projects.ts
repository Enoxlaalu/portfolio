...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: 'Vue Chat',
    description:
      'Real-time chat application built with Vue 3 and WebSocket — supports rooms, live messaging, and user auth.',
    longDescription:
      'A real-time chat application built with Vue 3 and WebSocket. Features user authentication, chat rooms, and live message delivery over a persistent WebSocket connection. Built with the Composition API and Vite.',
    gradient: 'sky',
    tags: [
      { label: 'Vue 3', color: 'green-600' },
      { label: 'TypeScript', color: 'blue-700' },
      { label: 'WebSocket', color: 'orange-500' },
      { label: 'Vite', color: 'yellow-600' },
    ],
    github: 'https://github.com/enoxlaalu/vuechat',
    githubRepo: 'enoxlaalu/vuechat',
    embedUrl: 'https://alex-vue-chat.netlify.app/',
  },
  {
    slug: 'aitiguru',
    name: 'AitiGuru',
